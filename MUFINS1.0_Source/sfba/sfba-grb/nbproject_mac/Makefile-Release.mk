...
# CC Compiler Flags
CCFLAGS=-stdlib=libstdc++ -std=c++11
...
LDLIBSOPTIONS=-L/Library/gurobi600/mac64/lib -lgurobi_c++ -lgurobi_g++4.2

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sfba-grb

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sfba-grb: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sfba-grb ${OBJECTFILES} ${LDLIBSOPTIONS} -lgurobi60 -lpthread -lm -stdlib=libstdc++

${OBJECTDIR}/DPA.o: DPA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DPA.o DPA.cpp

${OBJECTDIR}/Driver.o: Driver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Driver.o Driver.cpp

${OBJECTDIR}/DriverGrb.o: DriverGrb.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverGrb.o DriverGrb.cpp

${OBJECTDIR}/Elements.o: Elements.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Elements.o Elements.cpp

${OBJECTDIR}/GFA.o: GFA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GFA.o GFA.cpp

${OBJECTDIR}/GNI.o: GNI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GNI.o GNI.cpp

${OBJECTDIR}/Gurobi.o: Gurobi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gurobi.o Gurobi.cpp

${OBJECTDIR}/Matrix.o: Matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Matrix.o Matrix.cpp

${OBJECTDIR}/Model.o: Model.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model.o Model.cpp

${OBJECTDIR}/MtxLP.o: MtxLP.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MtxLP.o MtxLP.cpp

${OBJECTDIR}/RPN.o: RPN.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RPN.o RPN.cpp

${OBJECTDIR}/RecordParser.o: RecordParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RecordParser.o RecordParser.cpp

${OBJECTDIR}/SplitLP.o: SplitLP.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SplitLP.o SplitLP.cpp

${OBJECTDIR}/Text.o: Text.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Text.o Text.cpp

${OBJECTDIR}/TxtParser.o: TxtParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TxtParser.o TxtParser.cpp
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Library/gurobi600/mac64/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sfba-grb
