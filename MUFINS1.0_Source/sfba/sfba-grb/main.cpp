...
[-m] [-t] [-c] [-w] [-V max_rate] [-k temperature] [-q conc_range] [-d read_deltag]\n", program);
    ...
    printf("-solver    (-s) For GLPK solver you can choose simplex, exact or milp[,mip_gap] with optional mip gap tolerance of MILP; grb[,tol[,foc]] is for Gurobi solver with optional tolerance and MIPFocus.\n");
